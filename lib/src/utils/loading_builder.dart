          ...
          case ConnectionState.done:
            if (snapshot.hasError) {
              ...
              if (error is SocketException) {
                ...
                return Center(
                  child: Text(
                    S.of(context).please_check_your_connection != null && S.of(context).please_check_your_connection != ""
                        ? ""
                ...
                return Text(
                  S.of(context).please_check_your_connection != "" ? S.of(context).please_check_your_connection : 'Please check your connection',
                  overflow: TextOverflow.fade,
                );
              } else {
